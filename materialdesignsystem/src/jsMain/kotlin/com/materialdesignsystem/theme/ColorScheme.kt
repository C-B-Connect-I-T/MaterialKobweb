...
package com.materialdesignsystem.theme
...
//@Composable
//@ReadOnlyComposable
//internal fun ColorScheme.applyTonalElevation(backgroundColor: Color, elevation: CSSSizeValue<CSSUnit.px>): Color {
...
//    elevation: CSSSizeValue<CSSUnit.px>,
//): Color {
//    if (elevation == 0.px) return surface
//    val alpha = ((4.5f * ln(elevation.value + 1)) + 2f) / 100f
//    return surfaceTint.toRgb().copyf(alpha = alpha).compositeOver(surface)
//}
